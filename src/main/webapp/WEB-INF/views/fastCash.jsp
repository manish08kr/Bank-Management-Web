...
<body>
	...
	<form action="/fastCash" method="post">
		...
		<button type="submit" name="maount" value="2000">Rs 2000</button>
		<button type="submit" name="maount" value="5000">Rs 5000</button>
		<button type="submit" name="maount" value="10000">Rs 10000</button>
	</form>
